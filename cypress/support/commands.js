...
//
Cypress.Commands.add('validateResponse', (responseData, expectData) => {
      /**
     ...
     * ["lastName", "testLastName"]
     */
    cy.log(JSON.stringify(Object.entries(expectData)), 'ENTRIES RESULT')
    Object.entries(expectData).forEach(([key,value]) => {
